...
<div class="ozel3">
	...
	<div class="ozel7" style="max-height: 10000px">
					<%
					Set oConn = Server.CreateObject("ADODB.Connection")
					oConn.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("Veritabanim2.mdb"))
					ssql="select * from Photos ORDER BY photo_id;"
					ssql2="select * from PhotoComment ORDER BY comment_id;"
					...
					%>		
		<div class="photopage">
			<img src="Photos/<%=oRS("order")%>.jpg">
		</div><table  style="margin-left: 300px">
		<%	
	d=oRS("order")
	end if
	oRS.MoveNext
...
%>	<tr>
		<td colspan="3">
		<form action="photoyorum.asp" method="POST">
	  		<div>
