...
<div class="center" style="background-color:#e6e6ff; margin: 100px 20px 0px 10px;width:240px; height: 240px"">
	  		<img src="Photos/new/<%=oRS("photo_new")%>.jpg">
	  	</div>
	  	<div style="margin:auto;padding: auto; width: 1000px; ">
	  		<table  style="margin:0px padding: 0px">
	  			<tr>
	  				<td colspan="4"><p style="font-family:Serif;font-weight: bold;text-align: center">Personal Information</p>
	  				</td>
	  			</tr>
	  			<tr>
	  				<td width="100px">
	  					<p class="fonttype"  style="font-weight:bold;" style="font-weight: bold;">Name</p>  					
	  				</td>
	  				<td width="200px" height="5px">
				...
				<tr>	
	  			...
	  			<tr>
	  				<td>
	  					<p class="fonttype" style="font-weight: bold;">E-mail</p>  					
	  				</td>
	  				<td width="100px">
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("email")%></p>
	  				</td>
	  				<td> 
	  					<p class="fonttype" style="font-weight: bold;">School Number</p> 					
	  				</td>
	  				<td>
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("telnumber")%></p>				
	  				</td>
	  			</tr>
	  			<tr>
	  				<td>
	  				...
	  				<td width="100px">
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("university")%></p>
	  				</td>
	  				<td> 
	  					<p class="fonttype" style="font-weight: bold;">School Number</p> 					
	  				</td>
	  				<td>
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("department")%></p>				
	  				</td>
	  			</tr>
	  			<tr>
	  				<td>
	  				...
	  				<td width="100px">
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("job")%></p>
	  				</td>
	  				<td> 
	  					<p class="fonttype" style="font-weight: bold;">School Number</p> 					
	  				</td>
	  				<td>
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("Facebook_id")%></p>				
	  				</td>
	  			</tr>
	  			<tr>
	  				<td>
	  				...
	  				<td width="100px">
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("twitter_id")%></p>
	  				</td>
	  				<td> 
	  					<p class="fonttype" style="font-weight: bold;">School Number</p> 					
	  				</td>
	  				<td>
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("linkedin_id")%></p>				
	  				</td>
	  			</tr>
	  			<tr>
	  				<td>
	  				...
	  				<td width="100px">
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("hobbies")%></p>
	  				</td>
	  				<td> 
	  					<p class="fonttype" style="font-weight: bold;">School Number</p> 					
	  				</td>
	  				<td>
	  					<p class="fonttype" style="font-weight: normal">: <%=oRS("adress")%></p>				
	  				</td>
	  			</tr>
	  			<tr>
	  				<td>
...
<%	
		  	...
		  	<%	
					...
					<tr>
					<td>
					  	<form action="yorumyap2.asp" method="post" >
										...
										<td>	&nbsp;
											...
											<td>	&nbsp;
													<tr>
														<td colspan="2">	
														<div class="lastdiv">	
														<p style="font-family:Arial; font-weight:bold; text-align:right;margin-bottom:10px ">Design by © by M.Mustafa Okcen</p>
														</td>
														<td>
														<div class="center" style="border:none; width: 40px;height: 40px;margin-bottom:-10px;opacity: 0.5">
